...
async def send_welcome_message(context: ContextTypes.DEFAULT_TYPE, chat_id: int):
    ...
    greeting_part2 = (
        "📌 *Основные требования к объявлениям*:\n"
        "• Укажите действие (продам, обмен, куплю) или #офтоп.\n"
        ...
        "🔗 [Правила и примеры](https://t.me/shop_mrush1/11)\n"
...
async def show_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    help_text = (
        "📌 *Как подать объявление:*\n"
        "1. Подпишитесь на канал и зайдите в беседу:\n"
        f"   • {CHANNEL_ID}\n"
        f"   • {CHAT_ID}\n"
        ...
        "📌 *Основные правила:*\n"
        "- Указывать действие (продам/куплю/обмен) или #офтоп.\n"
        "- Указать, что с почтой (если по игре).\n"
        "- Запрещён мат, капс, ссылки (кроме t.me/shop_mrush1).\n"
        "- Обязательно: ваш @username.\n\n"
        "Более подробно см. в самом канале: [Правила](https://t.me/shop_mrush1/11)."
    )
    await update.message.reply_text(help_text, parse_mode="Markdown", reply_markup=BACK_BUTTON)
